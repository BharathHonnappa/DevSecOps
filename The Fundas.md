...
- How to review on a pull request.
- How to suggest changes to a pull request.
- How to merge a pull request after incorporating feedback.

# Version Control System
It is a is software that tracks changes to files over time, allowing individuals or teams to manage source code, revert to previous versions, and collaborate without overwriting work.
